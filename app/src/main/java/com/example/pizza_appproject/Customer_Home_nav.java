...
import com.example.pizza_appproject.databinding.ActivityCustomerHomeNavBinding;
import com.google.android.material.navigation.NavigationView;

public class Customer_Home_nav extends AppCompatActivity {

    private AppBarConfiguration mAppBarConfiguration;
    private ActivityCustomerHomeNavBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityCustomerHomeNavBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());

        navigationView = binding.navView;
        setSupportActionBar(binding.appBarCustomerHomeNav.toolbar);
        ...
        mAppBarConfiguration = new AppBarConfiguration.Builder(
                R.id.nav_home, R.id.nav_pizza_menu, R.id.nav_profile, R.id.nav_contacts, R.id.nav_favorite, R.id.nav_customeroffers, R.id.nav_cutomer_orders, R.id.nav_logout)
                .setOpenableLayout(drawer)
                .build();

        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_customer_home_nav);
        ...
        navigationView.setNavigationItemSelectedListener(item -> {
            ...
            if (id == R.id.nav_logout) {
                ...
                AlertDialog.Builder builder = new AlertDialog.Builder(Customer_Home_nav.this);
                builder.setTitle("Confirm Logout")
                        .setMessage("Are you sure you want to logout?")
                        .setNegativeButton("Cancel", null)
                        .setPositiveButton("Sure", (dialog, which) -> {
                            Intent intent = new Intent(Customer_Home_nav.this, LogIn_Activity.class);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.customer__home_nav, menu);
        return true;
    }
